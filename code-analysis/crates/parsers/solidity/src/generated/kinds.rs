...
pub enum Token {
    ...
    Do,
    DoubleQuote,
    DoubleQuoteAndOptionalPossiblySeparatedPairsOfHexDigitsAndDoubleQuote,
    ...
    Question,
    Quote,
    QuoteAndOptionalPossiblySeparatedPairsOfHexDigitsAndQuote,
    RawIdentifier,
    Receive,
    Reference,
    Relocatable,
...
pub enum Rule {
    ...
    OpenBracketAndOptionalExpressionAndCloseBracket,
