...
use codegen_testing::GrammarTestingExtensions;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    CodegenContext::with_context(repo_dir, |codegen| {
        ...
        grammar.generate_cst_output_tests(
            ...
            &codegen
                .repo_dir
                .join("code-analysis/crates/solidity/outputs/rust_lib_tests/snapshots/cst_output"),
            &codegen.repo_dir.join(
                "code-analysis/crates/solidity/outputs/rust_lib_tests/src/cst_output/generated",
            ),
        )?;
