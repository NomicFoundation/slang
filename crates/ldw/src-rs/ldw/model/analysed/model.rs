// Generated on 2024-11-13T12:02:54.128Z
...
pub struct Definition {
    pub name: String,
    pub r#type: Type,
    pub discrimination_peers: Option<std::collections::HashSet<String>>,
    pub discrimination_members: Option<std::collections::HashSet<String>>,
}
