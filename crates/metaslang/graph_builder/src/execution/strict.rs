...
impl Statement {
    ...
    fn execute(
        &self,
        exec: &mut ExecutionContext<'_, '_, '_, '_, '_>,
    ) -> Result<(), ExecutionError> {
...
impl AddGraphNodeAttribute {
    fn execute(
        ...
        let add_attribute =
            |exec: &mut ExecutionContext<'_, '_, '_, '_, '_>, name: Identifier, value: Value| {
                exec.graph[node]
                    .attributes
...
impl IntegerConstant {
    fn evaluate(
        &self,
        _exec: &mut ExecutionContext<'_, '_, '_, '_, '_>,
    ) -> Result<Value, ExecutionError> {
...
impl Variable {
    fn get<'a>(
        &self,
        exec: &'a mut ExecutionContext<'_, '_, '_, '_, '_>,
...
impl Attribute {
    ...
    where
        F: Fn(
            &mut ExecutionContext<'_, '_, '_, '_, '_>,
            Identifier,
            Value,
        ) -> Result<(), ExecutionError>,
    {
