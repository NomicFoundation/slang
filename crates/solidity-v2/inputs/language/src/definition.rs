...
StateVariableDefinition: StateVariableDefinition = {
    ...
    <l:@L> L_ErrorKeyword_Unreserved <r:@R>  <attributes: StateVariableAttributes>  <name: Identifier>  <value: (StateVariableDefinitionValue)?>  <semicolon: Semicolon> => {
        ...
        let type_name = parser_helpers::new_type_name_index_access_path(iap, l, file_id, diagnostics);
...
TypeName0<FunctionRule, IAPRule>: TypeName = {
    ...
    <l:@L> <index_access_path: IAPRule> => parser_helpers::new_type_name_index_access_path(index_access_path, l, file_id, diagnostics),
};
