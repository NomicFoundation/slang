...
MultiTypedDeclarationElements: MultiTypedDeclarationElements = {
    <prefix: TuplePrefix> <differentiator: VariableDeclaration> <_TypedTupleDeconstructionElement: (Comma <SepOne<Comma, <MultiTypedDeclarationElement>>>)?>  => {
...
IdentifierPathTailElements: Vec<IdentifierPathElement> = {
    <_MemberAccessIdentifier: SepOne<Period, <IdentifierPathElement>>>  => <>,
