...
pub struct DuplicateMutabilityKeyword {
...
impl DiagnosticExtensions for DuplicateMutabilityKeyword {
    fn severity(&self) -> DiagnosticSeverity {
        DiagnosticSeverity::Error
    }

    fn code(&self) -> &'static str {
        "semantic/duplicate-mutability-keyword"
    }
...
impl From<DuplicateMutabilityKeyword> for DiagnosticKind {
    fn from(d: DuplicateMutabilityKeyword) -> Self {
        Self::Semantic(SemanticDiagnosticKind::DuplicateMutabilityKeyword(d))
    }
}
