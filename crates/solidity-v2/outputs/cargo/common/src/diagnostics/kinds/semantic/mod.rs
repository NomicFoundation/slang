...
pub use overridable_kind::OverridableKind;
pub use override_changes_modifier_signature::OverrideChangesModifierSignature;
pub use override_changes_state_mutability::{OverrideChangesStateMutability, StateMutability};
...
pub use yul_unsupported_reference::{UnsupportedReferenceKind, YulUnsupportedReference};
...
define_diagnostic_kind! {
    ...
    pub enum SemanticDiagnosticKind {
        ...
        /// An overriding function changes the visibility of the overridden one.
