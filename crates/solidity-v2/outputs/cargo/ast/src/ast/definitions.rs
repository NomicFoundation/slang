...
pub enum Definition {
    ...
    YulParameter(Identifier),
    YulVariable(Identifier),
}
...
impl Definition {
    pub fn try_create(definition_id: NodeId, semantic: &Arc<SemanticContext>) -> Option<Self> {
        ...
        let definition = match definition {
            ...
            binder::Definition::Variable(variable_definition) => Self::Variable(
                create_variable_declaration(&variable_definition.ir_node, semantic),
            ),
            ...
            binder::Definition::YulParameter(yul_parameter_definition) => Self::YulParameter(
                create_identifier(&yul_parameter_definition.ir_node, semantic),
            ),
            binder::Definition::YulVariable(yul_variable_definition) => Self::YulVariable(
                create_identifier(&yul_variable_definition.ir_node, semantic),
            ),
        };
        Some(definition)
    }
    ...
    pub fn references(&self) -> Vec<Reference> {
        match self {
            ...
            Definition::Variable(variable_declaration) => variable_declaration.references(),
    ...
    pub fn enclosing_definition(&self) -> Option<Definition> {
        match self {
            ...
            Definition::Interface(interface_definition) => interface_definition.enclosing_definition(),
            ...
            Definition::Variable(variable_declaration) => variable_declaration.enclosing_definition(),
            Definition::YulFunction(yul_function_definition) => {
