...
use super::super::{
    ...
    Definition, ErrorDefinition, EventDefinition, FunctionDefinition, FunctionDefinitionStruct,
    FunctionKind, InterfaceDefinition, InterfaceMembersStruct, StateVariableDefinition,
};
