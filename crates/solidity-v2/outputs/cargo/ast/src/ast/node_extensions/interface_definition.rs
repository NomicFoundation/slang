...
use super::super::{
    Definition, ErrorDefinition, EventDefinition, FunctionDefinition, InterfaceDefinitionStruct,
};
...
impl InterfaceDefinitionStruct {
    ...
    /// so callers can decline the input.
    pub(crate) fn linearised_bases(&self) -> Vec<ContractBase> {
