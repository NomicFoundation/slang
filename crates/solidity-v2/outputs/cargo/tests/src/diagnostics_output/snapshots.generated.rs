...
mod semantic {
    ...
    mod assembly_references {
        ...
        #[test]
        fn calldata_slice_variable() -> Result<()> {
            run("semantic/assembly_references", "calldata_slice_variable")
        }

        #[test]
        fn calldata_slice_variable_read() -> Result<()> {
            run(
                "semantic/assembly_references",
                "calldata_slice_variable_read",
            )
        }

        #[test]
        fn calldata_slice_variable_slot_suffix() -> Result<()> {
            run(
                "semantic/assembly_references",
                "calldata_slice_variable_slot_suffix",
            )
        }
        ...
        #[test]
        fn extra_path_items_with_bad_suffix() -> Result<()> {
            run(
                "semantic/assembly_references",
                "extra_path_items_with_bad_suffix",
            )
        }
...
mod structure {
    ...
    mod contract_should_be_abstract {
        ...
        #[test]
        fn unimplemented_interface_fallback() -> Result<()> {
            run(
                "structure/contract_should_be_abstract",
                "unimplemented_interface_fallback",
            )
        }

        #[test]
        fn unimplemented_interface_receive() -> Result<()> {
            run(
                "structure/contract_should_be_abstract",
                "unimplemented_interface_receive",
            )
        }
