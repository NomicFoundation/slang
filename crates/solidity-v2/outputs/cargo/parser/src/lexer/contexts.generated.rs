...
pub enum SolidityContext {
    ...
    #[regex(r#"override"#, |_| { LexemeKind::OverrideKeyword_Reserved }, priority = 3000075)]
    ...
    #[regex(r#"receive"#, |_| { LexemeKind::ReceiveKeyword_Reserved }, priority = 3000083)]
    ...
    #[regex(r#"super"#, |_| { LexemeKind::SuperKeyword_Reserved }, priority = 3000096)]
    ...
    #[regex(r#"this"#, |_| { LexemeKind::ThisKeyword_Reserved }, priority = 3000100)]
    ...
    #[regex(r#"unchecked"#, |_| { LexemeKind::UncheckedKeyword_Reserved }, priority = 3000114)]
    ...
    #[regex(r#"virtual"#, |_| { LexemeKind::VirtualKeyword_Reserved }, priority = 3000118)]
    ...
    #[regex(r#"( |\t)+"#, |_| { LexemeKind::Whitespace }, priority = 1000184, allow_greedy = true)]
    #[regex(r#"\n|(\r\n?)"#, |_| { LexemeKind::EndOfLine }, priority = 1000185, allow_greedy = true)]
    #[regex(r#"//[^\r\n]*"#, |_| { LexemeKind::SingleLineComment }, priority = 1000186, allow_greedy = true)]
    #[regex(r#"/\*[^\*]*\*+([^/\*][^\*]*\*+)*/"#, |_| { LexemeKind::MultiLineComment }, priority = 1000187, allow_greedy = true)]
    #[regex(r#"///[^\r\n]*"#, |_| { LexemeKind::SingleLineNatSpecComment }, priority = 1000188, allow_greedy = true)]
    #[regex(r#"/\*\*([^/\*][^\*]*)?\*+([^/\*][^\*]*\*+)*/"#, |_| { LexemeKind::MultiLineNatSpecComment }, priority = 1000189, allow_greedy = true)]
    Lexeme(LexemeKind),
}
