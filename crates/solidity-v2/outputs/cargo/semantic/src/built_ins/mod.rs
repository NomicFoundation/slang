...
impl BuiltIn {
    ...
    pub fn to_public(&self) -> PublicBuiltIn {
        match self {
            BuiltIn::Abi => PublicBuiltIn::Abi,
            BuiltIn::AbiDecode => PublicBuiltIn::AbiDecode,
            BuiltIn::AbiEncode => PublicBuiltIn::AbiEncode,
            BuiltIn::AbiEncodeCall => PublicBuiltIn::AbiEncodeCall,
            BuiltIn::AbiEncodePacked => PublicBuiltIn::AbiEncodePacked,
            BuiltIn::AbiEncodeWithSelector => PublicBuiltIn::AbiEncodeWithSelector,
            BuiltIn::AbiEncodeWithSignature => PublicBuiltIn::AbiEncodeWithSignature,
            BuiltIn::Addmod => PublicBuiltIn::Addmod,
            BuiltIn::Address => PublicBuiltIn::Address,
            BuiltIn::AddressBalance => PublicBuiltIn::AddressBalance,
            BuiltIn::AddressCall => PublicBuiltIn::AddressCall,
            BuiltIn::AddressCallcode => PublicBuiltIn::AddressCallcode,
            BuiltIn::AddressCode => PublicBuiltIn::AddressCode,
            BuiltIn::AddressCodehash => PublicBuiltIn::AddressCodehash,
            BuiltIn::AddressDelegatecall => PublicBuiltIn::AddressDelegatecall,
            BuiltIn::AddressSend => PublicBuiltIn::AddressSend,
            BuiltIn::AddressStaticcall => PublicBuiltIn::AddressStaticcall,
            BuiltIn::AddressTransfer => PublicBuiltIn::AddressTransfer,
            BuiltIn::ArrayPop => PublicBuiltIn::ArrayPop,
            BuiltIn::ArrayPush(_) => PublicBuiltIn::ArrayPush,
            BuiltIn::Assert => PublicBuiltIn::Assert,
            BuiltIn::Blobhash => PublicBuiltIn::Blobhash,
            BuiltIn::Block => PublicBuiltIn::Block,
            BuiltIn::BlockBasefee => PublicBuiltIn::BlockBasefee,
            BuiltIn::BlockBlobbasefee => PublicBuiltIn::BlockBlobbasefee,
            BuiltIn::BlockChainid => PublicBuiltIn::BlockChainid,
            BuiltIn::BlockCoinbase => PublicBuiltIn::BlockCoinbase,
            BuiltIn::BlockDifficulty => PublicBuiltIn::BlockDifficulty,
            BuiltIn::BlockGaslimit => PublicBuiltIn::BlockGaslimit,
            BuiltIn::BlockNumber => PublicBuiltIn::BlockNumber,
            BuiltIn::BlockPrevrandao => PublicBuiltIn::BlockPrevrandao,
            BuiltIn::BlockTimestamp => PublicBuiltIn::BlockTimestamp,
            BuiltIn::Blockhash => PublicBuiltIn::Blockhash,
            BuiltIn::BytesConcat => PublicBuiltIn::BytesConcat,
            BuiltIn::CallOptionGas => PublicBuiltIn::CallOptionGas,
            BuiltIn::CallOptionSalt => PublicBuiltIn::CallOptionSalt,
            BuiltIn::CallOptionValue => PublicBuiltIn::CallOptionValue,
            BuiltIn::Ecrecover => PublicBuiltIn::Ecrecover,
            ...
            BuiltIn::Type(_) => PublicBuiltIn::Type,
            BuiltIn::TypeName => PublicBuiltIn::TypeName,
            BuiltIn::TypeCreationCode => PublicBuiltIn::TypeCreationCode,
            BuiltIn::TypeRuntimeCode => PublicBuiltIn::TypeRuntimeCode,
            BuiltIn::TypeInterfaceId => PublicBuiltIn::TypeInterfaceId,
            BuiltIn::TypeMin(_) => PublicBuiltIn::TypeMin,
            BuiltIn::TypeMax(_) => PublicBuiltIn::TypeMax,
            BuiltIn::Unwrap(_) => PublicBuiltIn::Unwrap,
            BuiltIn::Wrap(_) => PublicBuiltIn::Wrap,

            BuiltIn::YulAdd => PublicBuiltIn::YulAdd,
            BuiltIn::YulAddmod => PublicBuiltIn::YulAddmod,
            BuiltIn::YulAddress => PublicBuiltIn::YulAddress,
            BuiltIn::YulAddressField => PublicBuiltIn::YulAddressField,
            BuiltIn::YulAnd => PublicBuiltIn::YulAnd,
            BuiltIn::YulBalance => PublicBuiltIn::YulBalance,
            BuiltIn::YulBasefee => PublicBuiltIn::YulBasefee,
            BuiltIn::YulBlobbasefee => PublicBuiltIn::YulBlobbasefee,
            BuiltIn::YulBlobhash => PublicBuiltIn::YulBlobhash,
            BuiltIn::YulBlockhash => PublicBuiltIn::YulBlockhash,
            BuiltIn::YulByte => PublicBuiltIn::YulByte,
            BuiltIn::YulCall => PublicBuiltIn::YulCall,
            BuiltIn::YulCallcode => PublicBuiltIn::YulCallcode,
            BuiltIn::YulCalldatacopy => PublicBuiltIn::YulCalldatacopy,
            BuiltIn::YulCalldataload => PublicBuiltIn::YulCalldataload,
            BuiltIn::YulCalldatasize => PublicBuiltIn::YulCalldatasize,
            BuiltIn::YulCaller => PublicBuiltIn::YulCaller,
            BuiltIn::YulCallvalue => PublicBuiltIn::YulCallvalue,
            BuiltIn::YulChainid => PublicBuiltIn::YulChainid,
            BuiltIn::YulClz => PublicBuiltIn::YulClz,
            BuiltIn::YulCodecopy => PublicBuiltIn::YulCodecopy,
            BuiltIn::YulCodesize => PublicBuiltIn::YulCodesize,
            BuiltIn::YulCoinbase => PublicBuiltIn::YulCoinbase,
            BuiltIn::YulCreate => PublicBuiltIn::YulCreate,
            BuiltIn::YulCreate2 => PublicBuiltIn::YulCreate2,
            BuiltIn::YulDelegatecall => PublicBuiltIn::YulDelegatecall,
            BuiltIn::YulDifficulty => PublicBuiltIn::YulDifficulty,
            BuiltIn::YulDiv => PublicBuiltIn::YulDiv,
            BuiltIn::YulDup(_) => PublicBuiltIn::YulDup,
            BuiltIn::YulEq => PublicBuiltIn::YulEq,
            BuiltIn::YulExp => PublicBuiltIn::YulExp,
            BuiltIn::YulExtcodecopy => PublicBuiltIn::YulExtcodecopy,
            BuiltIn::YulExtcodehash => PublicBuiltIn::YulExtcodehash,
            BuiltIn::YulExtcodesize => PublicBuiltIn::YulExtcodesize,
            BuiltIn::YulGas => PublicBuiltIn::YulGas,
            BuiltIn::YulGaslimit => PublicBuiltIn::YulGaslimit,
            BuiltIn::YulGasprice => PublicBuiltIn::YulGasprice,
            ...
            BuiltIn::YulLt => PublicBuiltIn::YulLt,
            BuiltIn::YulMcopy => PublicBuiltIn::YulMcopy,
            BuiltIn::YulMload => PublicBuiltIn::YulMload,
            BuiltIn::YulMod => PublicBuiltIn::YulMod,
            BuiltIn::YulMsize => PublicBuiltIn::YulMsize,
            BuiltIn::YulMstore => PublicBuiltIn::YulMstore,
            BuiltIn::YulMstore8 => PublicBuiltIn::YulMstore8,
            BuiltIn::YulMul => PublicBuiltIn::YulMul,
            BuiltIn::YulMulmod => PublicBuiltIn::YulMulmod,
            BuiltIn::YulNot => PublicBuiltIn::YulNot,
            BuiltIn::YulNumber => PublicBuiltIn::YulNumber,
            BuiltIn::YulOffset => PublicBuiltIn::YulOffset,
            BuiltIn::YulOr => PublicBuiltIn::YulOr,
            BuiltIn::YulOrigin => PublicBuiltIn::YulOrigin,
            BuiltIn::YulPop => PublicBuiltIn::YulPop,
            BuiltIn::YulPrevrandao => PublicBuiltIn::YulPrevrandao,
            BuiltIn::YulReturn => PublicBuiltIn::YulReturn,
            BuiltIn::YulReturndatacopy => PublicBuiltIn::YulReturndatacopy,
            BuiltIn::YulReturndatasize => PublicBuiltIn::YulReturndatasize,
            BuiltIn::YulRevert => PublicBuiltIn::YulRevert,
            BuiltIn::YulSar => PublicBuiltIn::YulSar,
            BuiltIn::YulSdiv => PublicBuiltIn::YulSdiv,
            BuiltIn::YulSelector => PublicBuiltIn::YulSelector,
            ...
            BuiltIn::YulSload => PublicBuiltIn::YulSload,
            BuiltIn::YulSlot => PublicBuiltIn::YulSlot,
            BuiltIn::YulSlt => PublicBuiltIn::YulSlt,
            BuiltIn::YulSmod => PublicBuiltIn::YulSmod,
            BuiltIn::YulSstore => PublicBuiltIn::YulSstore,
            ...
            BuiltIn::YulTstore => PublicBuiltIn::YulTstore,
