    ...
    pub(super) fn check_solidity_reference(
        ...
        match definition {
            ...
            Definition::Variable(_) | Definition::Parameter(_) => {
                self.check_variable_reference(identifier, definition_id, suffix, false, is_lvalue);
            }
            _ => self.check_declaration_reference(identifier, definition_id, suffix, is_lvalue),
        }
    }
