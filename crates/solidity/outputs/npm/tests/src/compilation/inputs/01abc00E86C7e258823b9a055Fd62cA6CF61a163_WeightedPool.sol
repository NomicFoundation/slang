...
abstract contract BasePool is IBasePool, BasePoolAuthorization, BalancerPoolToken, TemporarilyPausable {
  ...
  function _onJoinPool(
    ...
    uint256 protocolSwapFeePercentage,
    bytes memory userData
  ) internal virtual returns (uint256 bptAmountOut, uint256[] memory amountsIn, uint256[] memory dueProtocolFeeAmounts);
  ...
  function _onExitPool(
    ...
    uint256 protocolSwapFeePercentage,
    bytes memory userData
  ) internal virtual returns (uint256 bptAmountIn, uint256[] memory amountsOut, uint256[] memory dueProtocolFeeAmounts);
