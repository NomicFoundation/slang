...
export enum RuleKind {
  ...
  EndOfFileTrivia = 41,
  EnumDefinition = 42,
  EqualityComparisonExpression = 43,
  EqualityComparisonOperator = 44,
  ErrorDefinition = 45,
  ErrorParameter = 46,
  EventDefinition = 47,
  EventParameter = 48,
  ExperimentalPragma = 49,
  ExponentiationExpression = 50,
  ExponentiationOperator = 51,
  Expression = 52,
  ExpressionStatement = 53,
  FallbackFunctionAttribute = 54,
  FallbackFunctionDefinition = 55,
  ForStatement = 56,
  FunctionAttribute = 57,
  FunctionCallExpression = 58,
  FunctionCallOperator = 59,
  FunctionCallOptions = 60,
  ...
  ImportDirective = 66,
  ImportPath = 67,
  IndexAccessExpression = 68,
  IndexAccessOperator = 69,
  InheritanceSpecifier = 70,
  InheritanceSpecifierList = 71,
  InterfaceDefinition = 72,
  LeadingTrivia = 73,
  LibraryDefinition = 74,
  MappingKeyType = 75,
  MappingType = 76,
  MappingValueType = 77,
  MemberAccessExpression = 78,
  MemberAccessOperator = 79,
  ModifierAttribute = 80,
  ModifierDefinition = 81,
  ModifierInvocation = 82,
  MulDivModExpression = 83,
  MulDivModOperator = 84,
  NamedArgument = 85,
  NamedArgumentList = 86,
  NewExpression = 87,
  NumberUnit = 88,
  NumericExpression = 89,
  OrExpression = 90,
  OrOperator = 91,
  OrderComparisonExpression = 92,
  OrderComparisonOperator = 93,
  OverrideSpecifier = 94,
  ParameterDeclaration = 95,
  ParameterList = 96,
  PayableType = 97,
  PositionalArgumentList = 98,
  PragmaDirective = 99,
  ...
  SimpleStatement = 110,
  SourceUnit = 111,
  StateVariableAttribute = 112,
  StateVariableDeclaration = 113,
  Statement = 114,
  StringExpression = 115,
  StructDefinition = 116,
  StructMember = 117,
  ThrowStatement = 118,
  TrailingTrivia = 119,
  TryStatement = 120,
  TupleDeconstructionStatement = 121,
  TupleExpression = 122,
  TypeExpression = 123,
  TypeName = 124,
  UnaryPostfixExpression = 125,
  UnaryPostfixOperator = 126,
  UnaryPrefixExpression = 127,
  UnaryPrefixOperator = 128,
  UncheckedBlock = 129,
  UnnamedFunctionAttribute = 130,
  UnnamedFunctionDefinition = 131,
  UserDefinedOperator = 132,
  UserDefinedValueTypeDefinition = 133,
  UsingDirective = 134,
  VariableDeclarationStatement = 135,
  VersionPragma = 136,
  VersionPragmaAlternatives = 137,
  VersionPragmaComparator = 138,
  VersionPragmaExpression = 139,
  VersionPragmaRange = 140,
  VersionPragmaSpecifier = 141,
  WhileStatement = 142,
  YulAssignmentStatement = 143,
  YulBlock = 144,
  YulBreakStatement = 145,
  YulContinueStatement = 146,
  YulDeclarationStatement = 147,
  YulExpression = 148,
  YulForStatement = 149,
  YulFunctionCallExpression = 150,
