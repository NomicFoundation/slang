...
switch (platform) {
  ...
  case 'win32':
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.win32-x64-msvc.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'ia32':
        localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.win32-ia32-msvc.node'))
        try {
          if (localFileExisted) {
        ...
        break
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.win32-arm64-msvc.node'))
        try {
          if (localFileExisted) {
    ...
    break
  case 'darwin':
    localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.darwin-universal.node'))
    try {
      if (localFileExisted) {
        nativeBinding = require('./solidity_typescript_lib.darwin-universal.node')
      } else {
        nativeBinding = require('solidity_typescript_lib-darwin-universal')
      }
      break
    } catch {}
    switch (arch) {
      case 'x64':
        ...
        break
      case 'arm64':
        localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.darwin-arm64.node'))
        try {
          if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.linux-x64-musl.node'))
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.linux-x64-gnu.node'))
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.linux-arm64-musl.node'))
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.linux-arm64-gnu.node'))
          try {
            if (localFileExisted) {
        ...
        break
      case 'arm':
        localFileExisted = existsSync(join(__dirname, 'solidity_typescript_lib.linux-arm-gnueabihf.node'))
        try {
          if (localFileExisted) {
...
const { NodeType, RuleNode, TokenNode, TokenKind, RuleKind, ProductionKind, Language, ParserOutput } = nativeBinding
