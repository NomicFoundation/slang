...
@contract [ContractDefinition
  [ContractSpecifiers [ContractSpecifier @specifier [InheritanceSpecifier]]]
] {
...
@contract [ContractDefinition
  [ContractSpecifiers [ContractSpecifier [InheritanceSpecifier
    [InheritanceTypes [InheritanceType @type_name [IdentifierPath]]]
  ]]]
] {
...
@contract [ContractDefinition
  ...
  ;; Resolve arguments in inheritance specifiers using the parent scope
  edge @args.lexical_scope -> @contract.parent_scope
}

@contract [ContractDefinition
  [ContractSpecifiers [ContractSpecifier
    [StorageLayoutSpecifier @expr [Expression]]
  ]]
] {
  ;; Resolve expressions in storage layout specifiers using the parent scope
  let @expr.lexical_scope = @contract.parent_scope
}
...
@tuple_decon [TupleDeconstructionStatement
    target: [TupleDeconstructionTarget variant: [VarTupleDeconstructionTarget
        [UntypedTupleDeconstructionElements
            @tuple_member [UntypedTupleDeconstructionElement @name name: [Identifier]]
        ]
    ]]
] {
  node def
...
;; Tuple deconstruction statements with explicit types
@tuple_decon [TupleDeconstructionStatement
    target: [TupleDeconstructionTarget variant: [TypedTupleDeconstructionTarget
        [TypedTupleDeconstructionElements
            [TypedTupleDeconstructionElement
                @tuple_member member: [TypedTupleDeconstructionMember
