...
@source_unit [SourceUnit [SourceUnitMembers
  ...
  node @contract_or_library.parent_scope
  edge @contract_or_library.lexical_scope -> @contract_or_library.parent_scope
  edge @contract_or_library.parent_scope -> @source_unit.lexical_scope
  ...
  edge @contract_or_library.push_extensions -> pop_extensions
  edge pop_extensions -> @source_unit.lexical_scope
}
...
@contract [ContractDefinition [ContractMembers
  ...
  edge @contract.parent_scope -> @contract.push_extensions
}
...
@library [LibraryDefinition @name name: [Identifier]] {
  ...
  ; bindings_output/using/qualified_type test).
...
@library [LibraryDefinition [LibraryMembers
  ...
  ; Connect the extensions push path
  edge @library.parent_scope -> @library.push_extensions
}
