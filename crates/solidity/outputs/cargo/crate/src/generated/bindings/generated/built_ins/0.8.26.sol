...
contract $SolidityBuiltIns$ {
  ...
  function require(bool condition, Error error) public;
...
contract $YulBuiltIns$ {
  ...
  function blobhash(uint256 i) public returns (uint256);
  function tload(uint256 p) public returns (uint256);
  function tstore(uint256 p, uint256 v) public;
