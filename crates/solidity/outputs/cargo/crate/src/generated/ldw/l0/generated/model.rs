...
pub type VersionTermRef = Box<VersionTerm>;
pub struct VersionTerm {
...
pub struct UsingDeconstructionSymbol {
    pub name: IdentifierPathRef,
    pub alias: Option<UsingAliasRef>,
}
...
pub type InheritanceTypeRef = Box<InheritanceType>;
pub struct InheritanceType {
    pub type_name: IdentifierPathRef,
...
pub type ModifierInvocationRef = Box<ModifierInvocation>;
...
pub struct TupleDeconstructionElement {
    pub member: Option<TupleMember>,
}

pub type TypedTupleMemberRef = Box<TypedTupleMember>;
...
pub struct TryStatement {
    ...
    pub returns: Option<ReturnsDeclarationRef>,
    pub body: BlockRef,
    pub catch_clauses: CatchClausesRef,
}
...
pub type FunctionCallExpressionRef = Box<FunctionCallExpression>;
...
pub type YulVariableDeclarationValueRef = Box<YulVariableDeclarationValue>;
pub struct YulVariableDeclarationValue {
    pub assignment: YulAssignmentOperator,
    pub expression: YulExpression,
}

pub type YulVariableAssignmentStatementRef = Box<YulVariableAssignmentStatement>;
pub struct YulVariableAssignmentStatement {
    pub variables: YulPathsRef,
    pub assignment: YulAssignmentOperator,
    pub expression: YulExpression,
}
...
pub enum SourceUnitMember {
    PragmaDirective(PragmaDirectiveRef),
    ImportDirective(ImportDirectiveRef),
    ContractDefinition(ContractDefinitionRef),
    InterfaceDefinition(InterfaceDefinitionRef),
    LibraryDefinition(LibraryDefinitionRef),
    StructDefinition(StructDefinitionRef),
    EnumDefinition(EnumDefinitionRef),
    FunctionDefinition(FunctionDefinitionRef),
    ErrorDefinition(ErrorDefinitionRef),
    UserDefinedValueTypeDefinition(UserDefinedValueTypeDefinitionRef),
    UsingDirective(UsingDirectiveRef),
    EventDefinition(EventDefinitionRef),
    ConstantDefinition(ConstantDefinitionRef),
}

pub enum Pragma {
    AbicoderPragma(AbicoderPragmaRef),
    ExperimentalPragma(ExperimentalPragmaRef),
    VersionPragma(VersionPragmaRef),
}
...
pub enum VersionExpression {
    VersionRange(VersionRangeRef),
    VersionTerm(VersionTermRef),
}
...
pub enum ImportClause {
    PathImport(PathImportRef),
    NamedImport(NamedImportRef),
    ImportDeconstruction(ImportDeconstructionRef),
}

pub enum UsingClause {
    IdentifierPath(IdentifierPathRef),
    UsingDeconstruction(UsingDeconstructionRef),
}
...
pub enum ContractMember {
    UsingDirective(UsingDirectiveRef),
    FunctionDefinition(FunctionDefinitionRef),
    ConstructorDefinition(ConstructorDefinitionRef),
    ReceiveFunctionDefinition(ReceiveFunctionDefinitionRef),
    FallbackFunctionDefinition(FallbackFunctionDefinitionRef),
    UnnamedFunctionDefinition(UnnamedFunctionDefinitionRef),
    ModifierDefinition(ModifierDefinitionRef),
    StructDefinition(StructDefinitionRef),
    EnumDefinition(EnumDefinitionRef),
    EventDefinition(EventDefinitionRef),
    ErrorDefinition(ErrorDefinitionRef),
    UserDefinedValueTypeDefinition(UserDefinedValueTypeDefinitionRef),
    StateVariableDefinition(StateVariableDefinitionRef),
}
...
pub enum TypeName {
    ArrayTypeName(ArrayTypeNameRef),
    FunctionType(FunctionTypeRef),
    MappingType(MappingTypeRef),
...
pub enum Statement {
    IfStatement(IfStatementRef),
    ForStatement(ForStatementRef),
    WhileStatement(WhileStatementRef),
    DoWhileStatement(DoWhileStatementRef),
    ContinueStatement(ContinueStatementRef),
    BreakStatement(BreakStatementRef),
    ReturnStatement(ReturnStatementRef),
    ThrowStatement(ThrowStatementRef),
    EmitStatement(EmitStatementRef),
    TryStatement(TryStatementRef),
    RevertStatement(RevertStatementRef),
    AssemblyStatement(AssemblyStatementRef),
    Block(BlockRef),
    UncheckedBlock(UncheckedBlockRef),
...
pub enum TupleMember {
    TypedTupleMember(TypedTupleMemberRef),
    UntypedTupleMember(UntypedTupleMemberRef),
}
...
pub enum Expression {
    AssignmentExpression(AssignmentExpressionRef),
    ConditionalExpression(ConditionalExpressionRef),
    OrExpression(OrExpressionRef),
    AndExpression(AndExpressionRef),
    EqualityExpression(EqualityExpressionRef),
    ComparisonExpression(ComparisonExpressionRef),
    BitwiseOrExpression(BitwiseOrExpressionRef),
    BitwiseXorExpression(BitwiseXorExpressionRef),
    BitwiseAndExpression(BitwiseAndExpressionRef),
    ShiftExpression(ShiftExpressionRef),
    AdditiveExpression(AdditiveExpressionRef),
    MultiplicativeExpression(MultiplicativeExpressionRef),
    ExponentiationExpression(ExponentiationExpressionRef),
    PostfixExpression(PostfixExpressionRef),
    PrefixExpression(PrefixExpressionRef),
    FunctionCallExpression(FunctionCallExpressionRef),
    CallOptionsExpression(CallOptionsExpressionRef),
    MemberAccessExpression(MemberAccessExpressionRef),
    IndexAccessExpression(IndexAccessExpressionRef),
    NewExpression(NewExpressionRef),
    TupleExpression(TupleExpressionRef),
    TypeExpression(TypeExpressionRef),
    ArrayExpression(ArrayExpressionRef),
    HexNumberExpression(HexNumberExpressionRef),
...
pub enum ArgumentsDeclaration {
    PositionalArgumentsDeclaration(PositionalArgumentsDeclarationRef),
    NamedArgumentsDeclaration(NamedArgumentsDeclarationRef),
}
...
pub enum StringExpression {
    StringLiteral(StringLiteral),
    StringLiterals(StringLiteralsRef),
    HexStringLiteral(HexStringLiteral),
    HexStringLiterals(HexStringLiteralsRef),
    UnicodeStringLiterals(UnicodeStringLiteralsRef),
}
...
pub enum YulStatement {
    YulBlock(YulBlockRef),
    YulFunctionDefinition(YulFunctionDefinitionRef),
    YulStackAssignmentStatement(YulStackAssignmentStatementRef),
    YulIfStatement(YulIfStatementRef),
    YulForStatement(YulForStatementRef),
    YulSwitchStatement(YulSwitchStatementRef),
    YulLeaveStatement(YulLeaveStatementRef),
    YulBreakStatement(YulBreakStatementRef),
    YulContinueStatement(YulContinueStatementRef),
    YulVariableAssignmentStatement(YulVariableAssignmentStatementRef),
    YulLabel(YulLabelRef),
    YulVariableDeclarationStatement(YulVariableDeclarationStatementRef),
...
pub enum YulSwitchCase {
    YulDefaultCase(YulDefaultCaseRef),
    YulValueCase(YulValueCaseRef),
}

pub enum YulExpression {
    YulFunctionCallExpression(YulFunctionCallExpressionRef),
...
pub type VersionExpressionSetRef = Box<VersionExpressionSet>;
pub struct VersionExpressionSet {
    pub item: std::collections::HashSet<VersionExpression>,
}

pub type ContractMembersRef = Box<ContractMembers>;
pub struct ContractMembers {
    pub item: std::collections::HashSet<ContractMember>,
}

pub type InterfaceMembersRef = Box<InterfaceMembers>;
pub struct InterfaceMembers {
    pub item: std::collections::HashSet<ContractMember>,
}

pub type LibraryMembersRef = Box<LibraryMembers>;
pub struct LibraryMembers {
    pub item: std::collections::HashSet<ContractMember>,
}

pub type StructMembersRef = Box<StructMembers>;
pub struct StructMembers {
    pub item: std::collections::HashSet<StructMemberRef>,
}

pub type StateVariableAttributesRef = Box<StateVariableAttributes>;
pub struct StateVariableAttributes {
    pub item: std::collections::HashSet<StateVariableAttribute>,
}

pub type FunctionAttributesRef = Box<FunctionAttributes>;
pub struct FunctionAttributes {
    pub item: std::collections::HashSet<FunctionAttribute>,
}

pub type ConstructorAttributesRef = Box<ConstructorAttributes>;
pub struct ConstructorAttributes {
    pub item: std::collections::HashSet<ConstructorAttribute>,
}

pub type UnnamedFunctionAttributesRef = Box<UnnamedFunctionAttributes>;
pub struct UnnamedFunctionAttributes {
    pub item: std::collections::HashSet<UnnamedFunctionAttribute>,
}

pub type FallbackFunctionAttributesRef = Box<FallbackFunctionAttributes>;
pub struct FallbackFunctionAttributes {
    pub item: std::collections::HashSet<FallbackFunctionAttribute>,
}

pub type ReceiveFunctionAttributesRef = Box<ReceiveFunctionAttributes>;
pub struct ReceiveFunctionAttributes {
    pub item: std::collections::HashSet<ReceiveFunctionAttribute>,
}

pub type ModifierAttributesRef = Box<ModifierAttributes>;
pub struct ModifierAttributes {
    pub item: std::collections::HashSet<ModifierAttribute>,
}

pub type FunctionTypeAttributesRef = Box<FunctionTypeAttributes>;
pub struct FunctionTypeAttributes {
    pub item: std::collections::HashSet<FunctionTypeAttribute>,
}

pub type StatementsRef = Box<Statements>;
pub struct Statements {
    pub item: std::collections::HashSet<Statement>,
}

pub type CatchClausesRef = Box<CatchClauses>;
pub struct CatchClauses {
    pub item: std::collections::HashSet<CatchClauseRef>,
}

pub type StringLiteralsRef = Box<StringLiterals>;
pub struct StringLiterals {
    pub item: std::collections::HashSet<StringLiteral>,
}

pub type HexStringLiteralsRef = Box<HexStringLiterals>;
pub struct HexStringLiterals {
    pub item: std::collections::HashSet<HexStringLiteral>,
}

pub type UnicodeStringLiteralsRef = Box<UnicodeStringLiterals>;
pub struct UnicodeStringLiterals {
    pub item: std::collections::HashSet<UnicodeStringLiteral>,
}

pub type YulStatementsRef = Box<YulStatements>;
pub struct YulStatements {
    pub item: std::collections::HashSet<YulStatement>,
}

pub type YulSwitchCasesRef = Box<YulSwitchCases>;
pub struct YulSwitchCases {
    pub item: std::collections::HashSet<YulSwitchCase>,
}

pub type VersionExpressionSetsRef = Box<VersionExpressionSets>;
pub struct VersionExpressionSets {
    pub item: std::collections::HashSet<VersionExpressionSetRef>,
}
...
pub struct ImportDeconstructionSymbols {
    pub item: std::collections::HashSet<ImportDeconstructionSymbolRef>,
}

pub type UsingDeconstructionSymbolsRef = Box<UsingDeconstructionSymbols>;
pub struct UsingDeconstructionSymbols {
    pub item: std::collections::HashSet<UsingDeconstructionSymbolRef>,
}

pub type InheritanceTypesRef = Box<InheritanceTypes>;
pub struct InheritanceTypes {
    pub item: std::collections::HashSet<InheritanceTypeRef>,
}
...
pub struct Parameters {
    pub item: std::collections::HashSet<ParameterRef>,
}

pub type OverridePathsRef = Box<OverridePaths>;
pub struct OverridePaths {
    pub item: std::collections::HashSet<IdentifierPathRef>,
}

pub type EventParametersRef = Box<EventParameters>;
pub struct EventParameters {
    pub item: std::collections::HashSet<EventParameterRef>,
}

pub type ErrorParametersRef = Box<ErrorParameters>;
pub struct ErrorParameters {
    pub item: std::collections::HashSet<ErrorParameterRef>,
}

pub type AssemblyFlagsRef = Box<AssemblyFlags>;
pub struct AssemblyFlags {
    pub item: std::collections::HashSet<StringLiteral>,
}

pub type TupleDeconstructionElementsRef = Box<TupleDeconstructionElements>;
pub struct TupleDeconstructionElements {
    pub item: std::collections::HashSet<TupleDeconstructionElementRef>,
}

pub type PositionalArgumentsRef = Box<PositionalArguments>;
pub struct PositionalArguments {
    pub item: std::collections::HashSet<Expression>,
}

pub type NamedArgumentsRef = Box<NamedArguments>;
pub struct NamedArguments {
    pub item: std::collections::HashSet<NamedArgumentRef>,
}

pub type CallOptionsRef = Box<CallOptions>;
pub struct CallOptions {
    pub item: std::collections::HashSet<NamedArgumentRef>,
}

pub type TupleValuesRef = Box<TupleValues>;
pub struct TupleValues {
    pub item: std::collections::HashSet<TupleValueRef>,
}

pub type ArrayValuesRef = Box<ArrayValues>;
...
pub struct YulArguments {
    pub item: std::collections::HashSet<YulExpression>,
}

pub type YulPathsRef = Box<YulPaths>;
pub struct YulPaths {
    pub item: std::collections::HashSet<YulPathRef>,
}
