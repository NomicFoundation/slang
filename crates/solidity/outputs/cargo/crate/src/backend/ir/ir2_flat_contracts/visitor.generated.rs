...
pub fn accept_string_expression(node: &StringExpression, visitor: &mut impl Visitor) {
    ...
    match node {
        StringExpression::Strings(strings) => {
            accept_strings(strings, visitor);
        }
        StringExpression::HexStrings(hex_strings) => {
            accept_hex_strings(hex_strings, visitor);
        }
        StringExpression::UnicodeStrings(unicode_strings) => {
...
pub fn accept_tuple_deconstruction_member(
    ...
    match node {
        TupleDeconstructionMember::VariableDeclarationStatement(variable_declaration_statement) => {
            accept_variable_declaration_statement(variable_declaration_statement, visitor);
        }
