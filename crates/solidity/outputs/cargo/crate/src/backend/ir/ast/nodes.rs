...
impl DefinitionStruct {
    ...
    define_variant!(Enum);
    define_variant!(EnumMember);
    define_variant!(Error);
    define_variant!(Event);
    define_variant!(Function);
    define_variant!(Import);
    define_variant!(ImportedSymbol);
    define_variant!(Interface);
    define_variant!(Library);
    define_variant!(Modifier);
    define_variant!(Parameter);
    define_variant!(StateVariable);
    define_variant!(Struct);
    define_variant!(StructMember);
    define_variant!(TypeParameter);
    define_variant!(UserDefinedValueType);
    define_variant!(Variable);
    define_variant!(YulFunction);
    define_variant!(YulLabel);
    define_variant!(YulParameter);
    define_variant!(YulVariable);
}
