...
macro_rules! define_wrapper {
    ($name:ident $impl:tt) => {
        paste::paste! {
            ...
            impl $crate::wit::utils::IntoFFI<ffi::$name> for rust::$name {
                #[inline]
            ...
            impl $crate::wit::utils::FromFFI<rust::$name> for ffi::$name {
                #[inline]
...
macro_rules! define_rc_wrapper {
    ($name:ident $impl:tt) => {
        paste::paste! {
            ...
            impl $crate::wit::utils::IntoFFI<ffi::$name> for std::rc::Rc<rust::$name> {
                #[inline]
                fn _into_ffi(self) -> ffi::$name {
                    ffi::$name::new([<$name Wrapper>](self))
                }
            ...
            impl $crate::wit::utils::FromFFI<std::rc::Rc<rust::$name>> for ffi::$name {
                #[inline]
