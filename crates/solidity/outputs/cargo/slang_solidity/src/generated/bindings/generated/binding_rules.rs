...
@contract [ContractDefinition @name name: [Identifier]] {
  ...
  attr (@contract.def) export_node = @contract.virtual_members
  ...
  attr (@contract.def) import_nodes = [@contract.lexical_scope, @contract.super_scope]
}
