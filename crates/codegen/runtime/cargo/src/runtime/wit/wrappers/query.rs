use crate::wit::utils::{define_refcell_wrapper, define_wrapper, IntoFFI};

mod ffi {
    pub use crate::wit::interface::exports::nomic_foundation::slang::query::{
        Guest, GuestQuery, GuestQueryMatchIterator, Query, QueryBorrow, QueryError, QueryMatch,
