    ...
    pub fn write_typescript_lib_sources(&self, codegen: &mut CodegenContext, output_dir: &PathBuf) {
        ...
        codegen
            .write_file(
                ...
                include_str!("../../parser_templates/src/shared/cst.rs"),
            )
            .unwrap();
        ...
        codegen
            .write_file(
                ...
                include_str!("../../parser_templates/src/typescript/cst_types.rs"),
            )
            .unwrap();
        ...
        codegen
            .write_file(
                ...
                include_str!("../../parser_templates/src/typescript/parser_output.rs"),
            )
            .unwrap();

        {
            let language_boilerplate_common =
                include_str!("../../parser_templates/src/shared/language.rs");
