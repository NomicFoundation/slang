...
impl break_statement::_S0 {
    pub fn new(((r#break, ignore), semicolon_char): (((), ignore::N), ())) -> Self {
        Self {
            r#break,
            ignore,
            semicolon_char,
...
impl comment::_S0 {
    pub fn new(
        (((slash_star, _c2s), star_chars), star_slash): ((((), Vec<Box<comment::_C2>>), usize), ()),
    ) -> Self {
        Self {
            slash_star,
            _c2s,
...
impl comment::_S3 {
    pub fn new((star_chars, _1): (usize, ())) -> Self {
        Self { star_chars, _1 }
    }
}
impl continue_statement::_S0 {
    pub fn new(((r#continue, ignore), semicolon_char): (((), ignore::N), ())) -> Self {
        Self {
            r#continue,
            ignore,
            semicolon_char,
...
impl line_comment::_S0 {
    pub fn new((slash_slash, _1): ((), usize)) -> Self {
        Self { slash_slash, _1 }
    }
}
...
impl positional_argument_list::_S2 {
    pub fn new((comma_char, ignore): ((), ignore::N)) -> Self {
...
impl unchecked_block::_S0 {
    pub fn new(((unchecked, ignore), block): (((), ignore::N), block::N)) -> Self {
        Self {
            unchecked,
            ignore,
            block,
...
impl decimal_integer::_S0 {
    pub fn new((expressions, underscore_chars): (Vec<()>, Vec<Option<()>>)) -> Self {
        Self {
            expressions,
            underscore_chars,
        }
...
impl fixed_bytes_type::_S0 {
    pub fn new((bytes, _1): ((), usize)) -> Self {
        Self { bytes, _1 }
    }
}
impl fixed_type::_S0 {
    pub fn new((fixed, _s2): ((), Option<Box<fixed_type::_S2>>)) -> Self {
        Self { fixed, _s2 }
    }
}
impl fixed_type::_S2 {
    pub fn new(((((_0, _1), _2), _3), _4): (((((), usize), ()), ()), usize)) -> Self {
        Self { _0, _1, _2, _3, _4 }
    }
}
...
impl signed_integer_type::_S0 {
    pub fn new((int, _1): ((), usize)) -> Self {
        Self { int, _1 }
    }
}
impl yul_decimal_number_literal::_S1 {
    pub fn new((_0, _1): ((), usize)) -> Self {
        Self { _0, _1 }
    }
}
impl yul_hex_literal::_S0 {
    pub fn new(((zero_x, _1), _2): (((), ()), usize)) -> Self {
        Self { zero_x, _1, _2 }
    }
}
impl decimal_exponent::_S0 {
    pub fn new(
        ((_0, minus_char), decimal_integer): (((), Option<()>), decimal_integer::N),
    ) -> Self {
        Self {
            _0,
            minus_char,
...
impl hex_number::_S0 {
    pub fn new(((zero_char, _1), _2): (((), ()), Box<hex_number::_S1>)) -> Self {
...
impl possibly_separated_pairs_of_hex_digits::_S0 {
    pub fn new((expressions, underscore_chars): (Vec<usize>, Vec<Option<()>>)) -> Self {
        Self {
            expressions,
            underscore_chars,
        }
...
impl ufixed_type::_S0 {
    pub fn new((_0, fixed_type): ((), fixed_type::N)) -> Self {
        Self { _0, fixed_type }
    }
}
...
impl unsigned_integer_type::_S0 {
    pub fn new((_0, signed_integer_type): ((), signed_integer_type::N)) -> Self {
        Self {
            _0,
            signed_integer_type,
        }
...
impl escape_sequence::_S0 {
    pub fn new((backslash_char, _c1): ((), Box<escape_sequence::_C1>)) -> Self {
        Self {
            backslash_char,
            _c1,
        }
...
impl hex_string_literal::_S0 {
    pub fn new((hex, _c1): ((), Box<hex_string_literal::_C1>)) -> Self {
        Self { hex, _c1 }
    }
}
...
impl elementary_type_with_payable::_S1 {
    pub fn new(((address, ignore), payable): (((), ignore::N), Option<()>)) -> Self {
        Self {
            address,
            ignore,
            payable,
...
impl assembly_flags::_S0 {
    pub fn new(
        ((((open_paren_char, ignore_0), _s2s), ignore_1), close_paren_char): (
            ((((), ignore::N), Box<assembly_flags::_S1>), ignore::N),
            (),
        ),
    ) -> Self {
        Self {
...
impl yul_function_call::_S0 {
    pub fn new(
        ((((((_c1, ignore_0), open_paren_char), ignore_1), _s3s), ignore_2), close_paren_char): (
            (
                (
                    (((Box<yul_function_call::_C1>, ignore::N), ()), ignore::N),
                    ...
                    (
                        (
                            (
                                (
                                    (
                                        (((((), ignore::N), yul_identifier::N), ignore::N), ()),
                                        ignore::N,
                                    ),
...
impl yul_function_definition::_S5 {
    pub fn new(
        ((minus_greater, ignore), _s7s): (((), ignore::N), Box<yul_function_definition::_S6>),
    ) -> Self {
        Self {
            minus_greater,
            ignore,
    ...
    pub fn new(
        (
            ...
            (
                (
                    (
                        (((((), ignore::N), identifier::N), ignore::N), ()),
                        ignore::N,
                    ),
...
impl identifier_path::_S2 {
    pub fn new((period_char, ignore): ((), ignore::N)) -> Self {
        Self {
            period_char,
            ignore,
        }
...
impl named_argument::_S0 {
    pub fn new(
        ((((identifier, ignore_0), colon_char), ignore_1), expression): (
            (((identifier::N, ignore::N), ()), ignore::N),
            expression::N,
        ),
    ) -> Self {
        Self {
...
impl selected_import::_S2 {
    pub fn new(((r#as, ignore), identifier): (((), ignore::N), identifier::N)) -> Self {
        Self {
            r#as,
            ignore,
            identifier,
            ...
            (
                (
                    (
                        (
                            (
                                (((((), ignore::N), ()), ignore::N), Box<mapping_type::_C1>),
                                ignore::N,
                            ),
                            (),
                        ),
...
impl named_argument_list::_S0 {
    pub fn new(
        ((((open_brace_char, ignore_0), _s2s), ignore_1), close_brace_char): (
            (
                (((), ignore::N), Option<Box<named_argument_list::_S1>>),
                ignore::N,
            ),
            (),
        ),
...
impl non_empty_parameter_list::_S0 {
    pub fn new(
        ((((open_paren_char, ignore_0), _s2s), ignore_1), close_paren_char): (
            (
                (((), ignore::N), Box<non_empty_parameter_list::_S1>),
                ignore::N,
            ),
            (),
        ),
...
impl override_specifier::_S0 {
    pub fn new(
        ((r#override, ignore), _s2): (((), ignore::N), Option<Box<override_specifier::_S2>>),
    ) -> Self {
        Self {
            r#override,
            ignore,
...
impl override_specifier::_S2 {
    pub fn new(
        ((((open_paren_char, ignore_0), identifier_paths), ignore_1), close_paren_char): (
            ((((), ignore::N), Vec<identifier_path::N>), ignore::N),
            (),
        ),
    ) -> Self {
        Self {
...
impl parameter_list::_S0 {
    pub fn new(
        ((((open_paren_char, ignore_0), _s2s), ignore_1), close_paren_char): (
            (
                (((), ignore::N), Option<Box<parameter_list::_S1>>),
                ignore::N,
            ),
            (),
        ),
            ...
            (
                (
                    (
                        (
                            (
                                (((), ignore::N), Box<selecting_import_directive::_S1>),
                                ignore::N,
                            ),
                            (),
                        ),
...
impl simple_import_directive::_S2 {
    pub fn new(
        (((r#as, ignore_0), identifier), ignore_1): ((((), ignore::N), identifier::N), ignore::N),
    ) -> Self {
        Self {
            r#as,
            ignore_0,
    ...
    pub fn new(
        (
            ...
            (
                (
                    (
                        (((((), ignore::N), ()), ignore::N), identifier::N),
                        ignore::N,
                    ),
                    (),
                ),
...
impl argument_list::_S0 {
    pub fn new(
        ((((open_paren_char, ignore_0), _c2), ignore_1), close_paren_char): (
            (
                (((), ignore::N), Option<Box<argument_list::_C2>>),
                ignore::N,
            ),
            (),
        ),
...
impl catch_clause::_S0 {
    pub fn new(
        ((((catch, ignore_0), _s2), ignore_1), block): (
            ((((), ignore::N), Option<Box<catch_clause::_S2>>), ignore::N),
            block::N,
        ),
    ) -> Self {
        Self {
...
impl function_type::_S0 {
    pub fn new(
        ((((((function, ignore_0), parameter_list), ignore_1), _s2s), ignore_2), _s4): (
            (
                (
                    ((((), ignore::N), parameter_list::N), ignore::N),
...
impl import_directive::_S0 {
    pub fn new(
        ((((import, ignore_0), _c1), ignore_1), semicolon_char): (
            ((((), ignore::N), Box<import_directive::_C1>), ignore::N),
            (),
        ),
    ) -> Self {
        Self {
...
impl yul_assignment::_S3 {
    pub fn new(
        ((((_s5s, ignore_0), colon_equal), ignore_1), yul_function_call): (
            (((Vec<Box<yul_assignment::_S5>>, ignore::N), ()), ignore::N),
            yul_function_call::N,
        ),
    ) -> Self {
        Self {
...
impl yul_assignment::_S5 {
    pub fn new(
        (((comma_char, ignore_0), yul_path), ignore_1): ((((), ignore::N), yul_path::N), ignore::N),
    ) -> Self {
        Self {
            comma_char,
            ignore_0,
...
impl yul_assignment::_S2 {
    pub fn new(
        ((colon_equal, ignore), yul_expression): (((), ignore::N), yul_expression::N),
    ) -> Self {
        Self {
            colon_equal,
            ignore,
...
impl yul_if_statement::_S0 {
    pub fn new(
        ((((r#if, ignore_0), yul_expression), ignore_1), yul_block): (
            ((((), ignore::N), yul_expression::N), ignore::N),
            yul_block::N,
        ),
    ) -> Self {
        Self {
...
impl yul_switch_statement::_S7 {
    pub fn new(((default, ignore), yul_block): (((), ignore::N), yul_block::N)) -> Self {
        Self {
            default,
            ignore,
            yul_block,
...
impl yul_switch_statement::_S4 {
    pub fn new(
        (((((case, ignore_0), yul_literal), ignore_1), yul_block), ignore): (
            (((((), ignore::N), yul_literal::N), ignore::N), yul_block::N),
            ignore::N,
        ),
    ) -> Self {
        Self {
...
impl yul_variable_declaration::_S8 {
    pub fn new(
        ((colon_equal, ignore), yul_function_call): (((), ignore::N), yul_function_call::N),
    ) -> Self {
        Self {
            colon_equal,
            ignore,
...
impl yul_variable_declaration::_S6 {
    pub fn new(
        ((comma_char, ignore), yul_identifier): (((), ignore::N), yul_identifier::N),
    ) -> Self {
        Self {
            comma_char,
            ignore,
...
impl type_name::_S3 {
    pub fn new(
        (((((open_bracket_char, ignore_0), expression), ignore_1), close_bracket_char), ignore): (
            (((((), ignore::N), Option<expression::N>), ignore::N), ()),
            ignore::N,
        ),
    ) -> Self {
        Self {
...
impl event_parameter::_S0 {
    pub fn new(
        ((((type_name, ignore_0), indexed), ignore_1), identifier): (
            (((type_name::N, ignore::N), Option<()>), ignore::N),
            Option<identifier::N>,
        ),
    ) -> Self {
        Self {
...
impl inheritance_specifier_list::_S0 {
    pub fn new(
        ((is, ignore), _s2s): (((), ignore::N), Box<inheritance_specifier_list::_S1>),
    ) -> Self {
        Self { is, ignore, _s2s }
    }
}
...
impl primary_expression::_S9 {
    pub fn new(
        ((((open_bracket_char, ignore_0), _s11s), ignore_1), close_bracket_char): (
            ((((), ignore::N), Box<primary_expression::_S10>), ignore::N),
            (),
        ),
    ) -> Self {
        Self {
...
impl primary_expression::_S4 {
    pub fn new(
        ((((open_paren_char, ignore_0), _s7s), ignore_1), close_paren_char): (
            ((((), ignore::N), Box<primary_expression::_S5>), ignore::N),
            (),
        ),
    ) -> Self {
        Self {
...
impl primary_expression::_S3 {
    pub fn new(((new, ignore), type_name): (((), ignore::N), type_name::N)) -> Self {
        Self {
            new,
            ignore,
            type_name,
...
impl primary_expression::_S1 {
    pub fn new(((payable, ignore), argument_list): (((), ignore::N), argument_list::N)) -> Self {
        Self {
            payable,
            ignore,
            argument_list,
                ...
                (
                    (
                        (
                            (
                                (
                                    ((((), ignore::N), Box<using_directive::_C1>), ignore::N),
                                    (),
                                ),
                                ignore::N,
                            ),
...
impl using_directive::_S2 {
    pub fn new(
        ((((open_brace_char, ignore_0), _s4s), ignore_1), close_brace_char): (
            ((((), ignore::N), Box<using_directive::_S3>), ignore::N),
            (),
        ),
    ) -> Self {
        Self {
...
impl yul_block::_S0 {
    pub fn new(
        ((((open_brace_char, ignore_0), _s2s), ignore_1), close_brace_char): (
            ((((), ignore::N), Vec<Box<yul_block::_S2>>), ignore::N),
            (),
        ),
    ) -> Self {
        Self {
...
impl index_access_expression::_S5 {
    pub fn new(
        ((colon_char, ignore), expression): (((), ignore::N), Option<expression::N>),
    ) -> Self {
        Self {
            colon_char,
            ignore,
            ...
            (
                (
                    (
                        (
                            (
                                (((), ignore::N), Vec<Box<variable_declaration_tuple::_S2>>),
                                ignore::N,
                            ),
...
impl variable_declaration_tuple::_S4 {
    pub fn new(
        (((comma_char, ignore_0), variable_declaration), ignore_1): (
            (((), ignore::N), Option<variable_declaration::N>),
            ignore::N,
        ),
    ) -> Self {
        Self {
...
impl member_access_expression::_S2 {
    pub fn new(
        (((period_char, ignore_0), _c3), ignore_1): (
            (((), ignore::N), Box<member_access_expression::_C3>),
            ignore::N,
        ),
    ) -> Self {
        Self {
...
impl function_call_options_expression::_S2 {
    pub fn new(
        (((((open_brace_char, ignore_0), _s4s), ignore_1), close_brace_char), ignore): (
            (
                (
                    (((), ignore::N), Box<function_call_options_expression::_S3>),
                    ignore::N,
                ),
                (),
            ),
...
impl unary_suffix_expression::_S0 {
    pub fn new(
        ((unary_prefix_expression, ignore), _1): ((unary_prefix_expression::N, ignore::N), ()),
    ) -> Self {
        Self {
...
impl exp_expression::_S0 {
    pub fn new(
        ((((unary_suffix_expression, ignore_0), star_star), ignore_1), expression): (
            (((unary_suffix_expression::N, ignore::N), ()), ignore::N),
            expression::N,
        ),
    ) -> Self {
        Self {
...
impl add_sub_expression::_S2 {
    pub fn new(
        (((_0, ignore_0), mul_div_mod_expression), ignore_1): (
            (((), ignore::N), mul_div_mod_expression::N),
            ignore::N,
        ),
    ) -> Self {
        Self {
...
impl bit_or_expression::_S2 {
    pub fn new(
        (((bar_char, ignore_0), bit_x_or_expression), ignore_1): (
            (((), ignore::N), bit_x_or_expression::N),
            ignore::N,
        ),
    ) -> Self {
        Self {
...
impl equality_comparison_expression::_S2 {
    pub fn new(
        (((_0, ignore_0), order_comparison_expression), ignore_1): (
            (((), ignore::N), order_comparison_expression::N),
            ignore::N,
        ),
    ) -> Self {
        Self {
...
impl and_expression::_S2 {
    pub fn new(
        (((ampersand_ampersand, ignore_0), equality_comparison_expression), ignore_1): (
            (((), ignore::N), equality_comparison_expression::N),
            ignore::N,
        ),
    ) -> Self {
        Self {
...
impl conditional_expression::_S2 {
    pub fn new(
        (
            ...
            (
                (((((), ignore::N), expression::N), ignore::N), ()),
                ignore::N,
            ),
            expression::N,
        ),
            ...
            (
                (
                    (
                        (
                            (
                                ((((type_name::N, ignore::N), ()), ignore::N), identifier::N),
                                ignore::N,
                            ),
                            (),
                        ),
...
impl expression_statement::_S0 {
    pub fn new(((expression, ignore), semicolon_char): ((expression::N, ignore::N), ())) -> Self {
        Self {
            expression,
            ignore,
            semicolon_char,
            ...
            (
                (
                    (
                        (
                            (
                                (((((), ignore::N), ()), ignore::N), expression::N),
                                ignore::N,
                            ),
                            (),
                        ),
...
impl if_statement::_S2 {
    pub fn new(((r#else, ignore), statement): (((), ignore::N), statement::N)) -> Self {
        Self {
            r#else,
            ignore,
            statement,
...
impl revert_statement::_S0 {
    pub fn new(
        ((((((revert , ignore_0) , expression) , ignore_1) , argument_list) , ignore_2) , semicolon_char) : ((((((() , ignore :: N) , expression :: N) , ignore :: N) , argument_list :: N) , ignore :: N) , ()),
    ) -> Self {
        Self {
            revert,
            ignore_0,
...
impl state_variable_declaration::_S4 {
    pub fn new(((equal_char, ignore), expression): (((), ignore::N), expression::N)) -> Self {
        Self {
            equal_char,
            ignore,
            expression,
...
impl variable_declaration_statement::_S5 {
    pub fn new(
        ((((variable_declaration_tuple, ignore_0), equal_char), ignore_1), expression): (
            (((variable_declaration_tuple::N, ignore::N), ()), ignore::N),
            expression::N,
        ),
    ) -> Self {
        Self {
...
impl block::_S0 {
    pub fn new(
        ((((open_brace_char, ignore_0), _s3s), ignore_1), close_brace_char): (
            ((((), ignore::N), Vec<Box<block::_S3>>), ignore::N),
            (),
        ),
    ) -> Self {
        Self {
                ...
                (
                    (
                        (
                            (
                                (
                                    ((((), ignore::N), Box<function_definition::_C1>), ignore::N),
                                    parameter_list::N,
                                ),
                                ignore::N,
                            ),
                    ...
                    (
                        (
                            (
                                (
                                    (
                                        ((((Option<()>, ignore::N), ()), ignore::N), identifier::N),
                                        ignore::N,
                                    ),
